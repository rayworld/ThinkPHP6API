...
class Captcha extends Common {
  ...
  public function getCaptcha() {
    ...
    $this->getCaptchaByAccountType($account_name, $account_type, $is_exist);
  }
   ...
   * @return void [空]
   */
  public function getCaptchaByAccountType($account_name, $account_type, $is_exist) {
    //取得账户类型描述
    ...
    if ($account_type == 'mobile') {
      //生成手机验证码
      $this->sendCaptchaByMobile($account_name, $captcha);
    } else {
      //生成邮箱验证码
      $this->sendCaptchaByEmail($account_name, $captcha);
    }
  }
   ...
   */
  public function makeCaptcha($num) {
    $max = pow(10, $num) - 1;
    $min = pow(10, ($num - 1));
    return rand($min, $max);
  }
   ...
   * @return void [空]
   */
  public function sendCaptchaByMobile($account_name, $captcha) {
   ...
   * @return void [空]
   */
  public function sendCaptchaByEmail($account_name, $captcha) {
